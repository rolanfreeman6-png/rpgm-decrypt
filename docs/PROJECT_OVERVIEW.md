...
| Файл | LoC | Назначение | GitHub |
|---|---:|---|---|
| `Program.fs` | ~180 | Arg parser, key resolution (--password/--password-file/--vxace-seed/auto), exit codes | [→](https://github.com/rolanfreeman6-png/rpgm-decrypt/blob/main/src/RpgmDecrypt.Cli/Program.fs) |
