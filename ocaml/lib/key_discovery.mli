...
(** [discover game_dir] searches the standard locations
    (www/js/System.json -> www/data/System.json -> www/js/rpg_core.js -> sweep
    www/js -> sweep www) for a 32-hex-char encryption key. *)
